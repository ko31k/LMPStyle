            ...
            if (data.type === 'complite' && settings.info_panel) {
                setTimeout(function() {
                    ...
                    var newContainer = $('<div>').css({
                        ...
                        'width': '100%',
                        'gap': '0em', //Змінено з 'gap': '0.6em'
                        'margin': '-1em 0 0.2em 0' //Змінено з 'margin': '0.6em 0 0.6em 0'
                    });
                    var firstRow = $('<div>').css({
                        'display': 'flex',
                        'flex-wrap': 'wrap',
                        'gap': '0.2em', //Змінено з 'gap': '0.4em',
                        'align-items': 'center',
                        'margin': '0 0 0.1em 0' //Змінено з 'margin': '0 0 0.2em 0'
                    });
                    ...
                    tempContainer.find('span').each(function() {
                        ...
                        var baseStyle = { 'border-radius': '0.3em', 'border': '0px', 'font-size': '1.0em', 'padding': '0.2em 0.6em', 'display': 'inline-block', 'white-space': 'nowrap', 'line-height': '1.2em', 'margin-right': '0.2em', 'margin-bottom': '0.2em' }; //Зміннено з 'margin-right': '0.4em'
                        ...
                        if (genres.length > 1) {
                            ...
                            for (var i = 0; i < genres.length; i++) {
                                ...
                                var $badge = $('<span>').text(genre).css($.extend({}, baseStyle, { 'background-color': color.bg, 'color': color.text, 'margin-right': '0.2em' })); //Змінено з 'margin': '0.2em'
                            ...
                            var genre = text.trim();
                            var color = colors.genres[genre] || { bg: 'rgba(255, 255, 255, 0.1)', text: 'white' };
                            $span.css($.extend({}, baseStyle, { 'background-color': color.bg, 'color': color.text, 'margin-right': '0.4em' })); //Змінено з 'margin': '0.2em'
                    ...
                    if (isTvShow && movie && movie.seasons && Array.isArray(movie.seasons)) {
                        ...
                        if (episodesText) {
                            var baseStyle = { 'border-radius': '0.3em', 'border': '0px', 'font-size': '1.0em', 'padding': '0.2em 0.6em', 'display': 'inline-block', 'white-space': 'nowrap', 'line-height': '1.2em', 'margin-right': '0.2em', 'margin-bottom': '0.2em' }; //Змінено з 'margin-right': '0.4em'
                        ...
                        if (movie.next_episode_to_air && movie.next_episode_to_air.air_date && airedEpisodes < totalEpisodes) {
                            ...
                            if (nextText) {
                                var nextStyle = { 'border-radius': '0.3em', 'border': '0px', 'font-size': '1.0em', 'padding': '0.2em 0.6em', 'display': 'inline-block', 'white-space': 'nowrap', 'line-height': '1.2em', 'background-color': colors.next.bg, 'color': colors.next.text, 'margin-right': '0.2em', 'margin-bottom': '0.2em' }; //Змінено з 'margin-right': '0.4em'
                    ...
                    if (!isTvShow && movie && movie.runtime > 0) {
                        ...
                        var $badge = $('<span>').text(text).css({
                            ...
                            'margin': '0.2em',
                            'margin-right': '0.2em', //Змінено з 'margin-right': '0.4em'
                            'margin-bottom': '0.2em'
                        });
