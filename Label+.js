(function () {
    ...
    function initPlugin() {
        ...
        var style = $('<style>' +
            ...
            '.card--new_seria { position: absolute; top: 5em; right: 0; width: auto; max-width: 100%; font-size: 1em; padding: 0.15em 1em; border-radius: 1em 0 0 1em; z-index: 11; background: rgba(0,0,0,0.3); color: #fff; text-align: center; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; font-weight: bold; }' +
