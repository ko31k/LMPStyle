(function () {
    ...
    '.card--new_seria { position: absolute; top: 2.0em; right: 0; width: auto; max-width: 100%; font-size: 0.9375em; padding: 0.3125em 0.9375em; border-radius: 0.9375em 0 0 0.9375em; z-index: 11; background: rgba(0,0,0,0.5); color: #fff; text-align: center; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; font-weight: 500; line-height: 1.3; backdrop-filter: blur(0.625em); }' +
