(function () {
    ...
    Lampa.Lang.add({
        ...
        season_seria_active: {
            en: "Season {season} / Episodes {current}/{total}",
            uk: "Сезон {season} / Епізодів {current}/{total}",
            ru: "Сезон {season} / Эпизодов {current}/{total}"
        },
        ...
        season_seria_no_episodes: {
            en: "Season {season} / Episodes 0/{total}",
            uk: "Сезон {season} / Епізодів 0/{total}",
            ru: "Сезон {season} / Эпизодов 0/{total}"
        },
    ...
    function initPlugin() {
        ...
        var style = $('<style>' +
            ...
            '.card--new_seria { position: absolute; top: 3.25em; right: 0; width: auto; max-width: 100%; font-size: 12px; padding: 4px 12px; border-radius: 12px 0 0 12px; z-index: 11; background: rgba(0,0,0,0.7); color: #fff; text-align: center; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; font-weight: 500; line-height: 1.3; backdrop-filter: blur(5px); }' +
