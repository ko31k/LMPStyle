...
"</style>";
            ...
            fetchWithProxy(apiUrl, cardId, function(error, responseText) {
                ...
                try {
                    ...
                    for (var i = 0; i < torrents.length; i++) {
                        ...
                        if (LQE_CONFIG.LOGGING_QUALITY) console.log("LQE-QUALITY", "card: " + cardId + ", Torrent: " + currentTorrent.title + " | Quality: " + currentNumericQuality + "p | Year: " + (isYearValid ? parsedYear : "unknown") + " | Strategy: " + strategyName);
    ...
    function getQualityCache(key) {
        ...
        if (LQE_CONFIG.LOGGING_QUALITY) console.log("LQE-QUALITY", "Cache: Checking quality cache for key:", key, "Found:", !!item, "Valid:", isCacheValid);
    ...
    function saveQualityCache(key, data, cardId) {
        ...
        var cache = Lampa.Storage.get(LQE_CONFIG.CACHE_KEY) || {};
        cache[key] = {quality_code: data.quality_code, full_label: data.full_label, timestamp: Date.now()};
    ...
    function updateCardListQuality(cardElement) {
        ...
        var cardView = cardElement.querySelector(actualSelectors.listCardView);
    ...
    // ==================== ІНІЦІАЛІЗАЦІЯ ТА СПОСТЕРЕЖЕННЯ ====================
    ...
    if (!window.lampaQualityPlugin) initializeLampaQualityPlugin();
})();
