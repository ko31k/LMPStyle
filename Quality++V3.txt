(function() {
    ...
    function translateQualityLabel(qualityCode, fullTorrentTitle) {
        ...
        // 3-Комбінуємо роздільність та джерело
        var finalLabel = '';
        ...
        // 4-Fallback на пряму мапу Якщо не знайшли ні роздільність, ні джерело
    ...
    function getBestReleaseFromJacred(normalizedCard, cardId, callback) {
        enqueueTask(function (done) {
		   ...
		   // Стратегія 1: Оригінальна назва + точний рік
			...
			// !!! "Локалізована назва + точний рік" (змінена) 
