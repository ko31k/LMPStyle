(function () {
    ...
    // Стилі в стилі Quality+.js, але для правого нижнього кута
    ...
    // Поліпшена функція перевірки завершеності сезону
    function isSeasonComplete(cardData) {
        try {
            ...
            var currentSeason = cardData.seasons.find(function(season) {
                return season.season_number === lastEpisode.season_number && season.season_number > 0;
            });
            
            if (!currentSeason) return false;
            
            var totalEpisodes = parseInt(currentSeason.episode_count) || 0;
    ...
    // MutationObserver (як у Quality+.js)
