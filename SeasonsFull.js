(function () {
    ...
    .card--season-progress {
        ...
        margin-left: -0.65em; //ВІДСТУП за лівий край 
        bottom: 0.50em;
        background-color: rgba(255, 66, 66, 0.9);   /* Жовтий колір, rgba(255, 193, 7, 0.9) стандартна прозорість фону 0.8 (1 - фон не прозорий)  //колір як в стандартної мітки TV -> rgba(255, 66, 66, 1)*/
        z-index: 12;
        width: fit-content;
        max-width: calc(100% - 1em);
        border-radius: 0.3em 0.3em 0.3em 0.3em;
