...
(function() {
    ...
    /*var ukraineFlagSVG = `
        <svg class="flag-svg" viewBox="0 0 30.125 15" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <clipPath id="flagClip">
              <rect width="30.125" height="15" rx="1.8" ry="1.8" />
            </clipPath>
            
            </defs>
          
          <g clip-path="url(#flagClip)">
            <rect width="30.125" height="7.5" y="0" fill="#0057B7" />
            <rect width="30.125" height="7.5" y="7.5" fill="#FFD700" />
            </g>
        </svg>`;*/
...
var styleTracks = "<style id=\"lampa_tracks_styles\">" +
    ...
    /*
    // Стилі для SVG-прапора - точне вирівнювання та розмір
    ...
    /* 🔻🔻🔻 ОНОВЛЕНИЙ БЛОК ДЛЯ 3D-ЕФЕКТУ (ТЕМНІ ВІДТІНКИ + РАМКА) 🔻🔻🔻 */
    ...
    // ✅ 3. Тонка зовнішня рамка (Нове!)
    " border: 1px solid #1A1A1A;" + // Тонка темно-сіра рамка
    
    // ✅ 4. Створення "об'єму" з темними відтінками
    " box-shadow: " +
        // Внутрішня тінь (Темний Синій) - імітує заглиблення зверху
        "inset 0px 1px 0px 0px #004593, " + 
        // Внутрішня тінь (Темний Жовтий) - імітує заглиблення знизу
    ...
    " height: 0.8em;" +
    " vertical-align: middle;" +
    // Малюємо прапор за допомогою градієнта
    " background: linear-gradient(to bottom, #0057B7 0%, #0057B7 50%, #FFD700 50%, #FFD700 100%);" +
    // 1. Додаємо легке заокруглення
    " border-radius: 2px;" + 
    // 2. Додаємо тонку світлу рамку для чіткості
