/**
 * Lampa Track Finder v2.6 - OPTIMIZED
 * --------------------------------------------------------------------------------
 ...
 * --------------------------------------------------------------------------------
 * OPTIMIZED v2.6: Покращена стабільність, retry-механізм, адаптивна черга
 */
(function() {
    ...
    var LTF_CONFIG = {
        // --- Налаштування кешу ---
        CACHE_VERSION: 6, // Версія кешу. Змініть, якщо хочете скинути старі збережені дані.
