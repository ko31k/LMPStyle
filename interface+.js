            ...
            if (data.type === 'complite' && settings.info_panel) {
                setTimeout(function() {
                    ...
                    tempContainer.find('span').each(function() {
                        ...
                        var baseStyle = { 'border-radius': '0.3em', 'border': '0px', 'font-size': '1.0em', 'padding': '0.2em 0.6em', 'display': 'inline-block', 'white-space': 'nowrap', 'line-height': '1.2em', 'margin-right': '0.4em', 'margin-bottom': '0.0em' }; //ЗМІНЕНО з 0.2
                        ...
                        if (genres.length > 1) {
                            ...
                            for (var i = 0; i < genres.length; i++) {
                                ...
                                var $badge = $('<span>').text(genre).css($.extend({}, baseStyle, { 'background-color': color.bg, 'color': color.text, 'margin': '0.0em' })); //ЗМІНЕНО з 0.2
                            ...
                            var genre = text.trim();
                            var color = colors.genres[genre] || { bg: 'rgba(255, 255, 255, 0.1)', text: 'white' };
                            $span.css($.extend({}, baseStyle, { 'background-color': color.bg, 'color': color.text, 'margin': '0.0em' })); //ЗМІНЕНО 0.2
