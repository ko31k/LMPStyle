(function () {
    ...
    function addSettings() {
        ...
        // Перемещаем пункт "Интерфейс MOD" сразу после "Интерфейс"
        ...
        setTimeout(function() {
            ...
            var $settingsList = $('.settings__list');
            if ($settingsList.length) {
                var observer = new MutationObserver(function() {
                    moveModSettingsFolder();
                });
                observer.observe($settingsList[0], { childList: true });
            }
        }, 1000);
        ...
        Lampa.SettingsApi.addParam({
            ...
            param: {
                ...
                values: {
                    ...
                    'main2': 'Основной стиль 2'
                },
                default: 'default'
            },
            field: {
                name: Lampa.Lang.translate('interface_mod_new_buttons_style_mode'),
                description: 'Стиль отображения кнопок в карточке фильма'
            },
            onChange: function(value) {
        ...
        loadExternalThemes(function(error, externalThemes) {
            if (!error && externalThemes && externalThemes.themes) {
                externalThemes.themes.forEach(function(theme) {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function(value) {
                ...
                if (value) {
                    ...
                    var styleElement = document.getElementById('stylized-titles-css');
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function(value) {
                ...
                if (value) {
                    ...
                    var styleElement = document.getElementById('enhanced-info-css');
                    if (styleElement) styleElement.remove();
                }
            }
        });
        ...
        if (!document.getElementById('interface_mod_new_buttons_style')) {
            ...
            buttonStyle.innerHTML = `
                ...
                .custom-online-btn { 
                    ...
                    box-shadow: 0 0 13px #00b2ff !important; 
                ...
                .custom-torrent-btn { 
                    background-color: #2f2f2fd1 !important; 
                    box-shadow: 0 0 13px #00ff40 !important; 
                }
                ...
                .main2-more-btn { 
                    ...
                    box-shadow: 0 0 13px #e67e22 !important; 
                }
                ...
                @media (max-width: 600px) {
                    .custom-online-btn { 
                        background-color: #2f2f2fd1 !important; 
                        box-shadow: 0 0 8px #00b2ff !important; 
                        margin: 0.8em !important; 
                    }
                    
                    .custom-torrent-btn { 
                        background-color: #2f2f2fd1 !important; 
                        box-shadow: 0 0 8px #00ff40 !important; 
                    }
    ...
    function applyTheme(theme) {
        ...
        const themes = {
            minimalist: `
                ...
                .card__title, .card__vote, .full-start__title, .full-start__rate, 
                .full-start-new__title, .full-start-new__rate {
                    color: #e0e0e0 !important;
                }
                
                @media (max-width: 768px) {
                    .menu__item, .settings-folder, .settings-param {
            ...
            glow_outline: `
                ...
                .menu__item.focus::before, .settings-folder.focus::before, 
                .settings-param.focus::before, .selectbox-item.focus::before,
                .custom-online-btn.focus::before, .custom-torrent-btn.focus::before, 
                .main2-more-btn.focus::before, .simple-button.focus::before {
                    content: '' !important;
                    position: absolute !important;
                    top: -2px !important;
                    left: -2px !important;
