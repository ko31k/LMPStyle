(function() {
    ...
    // Вагові коефіцієнти для середнього рейтингу
    var WEIGHTS = {
        imdb: 0.40,
        tmdb: 0.40,
        mc: 0.10,
    ...
    // Основна функція отримання рейтингів
    function fetchAdditionalRatings(card, render) {
        ...
        function updateUI() {
            ...
            // Прибираємо анімацію та показуємо рейтинги
    ...
    // Функція отримання рейтингів з OMDb API
    ...
    // Витягування рейтингу з даних OMDb
        ...
        for (var i = 0; i < ratings.length; i++) {
            if (ratings[i].Source === source) {
                try {
                    ...
                    console.warn('Помилка при парсингу рейтингу:', e);
                    return null;
                }
            }
        }
    ...
    function insertRatings(rtRating, mcRating, oscars, awards, emmy, localCurrentCard, render) {
        ...
        // Вставка рейтингу Rotten Tomatoes
    ...
    // Запуск плагіна
    if (!window.maxsmOmdbPlugin) startPlugin();
