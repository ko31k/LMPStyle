(function() {
    ...
    /**
     * =========================
     * Emmy SVG (з робочого omdb+mod.js)
     * =========================
     */
    ...
    /**
     * =========================
     * Генератори іконок (з omdb+mod.js, АЛЕ З ВИПРАВЛЕННЯМ)
     * =========================
     */
    ...
    /**
     * Парсимо текст нагород OMDB (з omdb+mod.js)
     */
    ...
    /**
     * Змерджити MDBList + OMDB (з omdb+mod.js)
     */
    ...
    /**
     * Додаємо нові бейджі (з omdb+mod.js)
     */
    ...
    /**
     * TOTAL / середній рейтинг (з omdb+mod.js)
     */
    ...
    /**
     * Основна логіка (з omdb+mod.js, з доповненнями)
     */
    function fetchAdditionalRatings(card) {
        ...
        function renderAll() {
            ...
            // [ВИПРАВЛЕНО] Викликаємо applyStylesToAll, щоб застосувати налаштування з меню
            applyStylesToAll();
        }
    ...
    function tuneGap(gapStep){
        ...
        // CSS з omdb+mod.js вже ставить 0.3em !important,
        // тому ця функція з rt.js може не працювати як очікувалось.
        // Але логіка меню лишається.
        var totalEm = (0.3 + gapStep * 0.1); // 0.3 - база з CSS
