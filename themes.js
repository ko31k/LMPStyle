(function() {
    ...
    function removeFromSettingsMenu() {
        ...
        Lampa.Storage.set('light_version', 'false'); !important;
        Lampa.Storage.set('background', 'false'); !important;
        Lampa.Storage.set('card_interfice_type', 'new'); !important;
        Lampa.Storage.set('glass_style', 'false'); !important;
        Lampa.Storage.set('card_interfice_poster', 'false'); !important;
        Lampa.Storage.set('card_interfice_cover', 'true'); !important;
        Lampa.Storage.set('advanced_animation', 'false'); !important;
