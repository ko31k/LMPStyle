 ...
 * - Додає рамки навколо торрент-блоків з кольорами за кількістю роздаючих
 ...
 * 3. Рамки для торрент-блоків з кольоровою кодуванням
...
(function(){
    ...
    const FLAG_STYLES = `
        ...
        /* ===================== СТИЛІ ДЛЯ ТОРРЕНТ-БЛОКІВ З РАМКАМИ ===================== */
        /* Основний стиль для торрент-блоків з рамками */
        .torrent-item {
            position: relative;
            margin: 12px 0;
            padding: 16px;
        ...
        /* Рамки за кількістю роздаючих - ПРИГЛУШЕНІ КОЛЬОРИ */
        .torrent-item.low-seeds-border {
            border-color: #8B4513 !important; /* Темно-коричневий замість червоного */
            background: linear-gradient(135deg, rgba(30, 30, 35, 0.8), rgba(139, 69, 19, 0.1));
        }

        .torrent-item.medium-seeds-border {
            border-color: #B8860B !important; /* Темно-золотий замість жовтого */
            background: linear-gradient(135deg, rgba(30, 30, 35, 0.8), rgba(184, 134, 11, 0.1));
        }

        .torrent-item.high-seeds-border {
            border-color: #2F4F2F !important; /* Темно-оливковий замість зеленого */
    ...
    function updateTorrentStyles() {
        ...
        torrentItems.forEach(item => {
            ...
            item.classList.remove('low-seeds-border', 'medium-seeds-border', 'high-seeds-border');
            
            // Додаємо новий клас рамки за кількістю роздаючих
            if (seeds <= 4) {
                item.classList.add('low-seeds-border');        // Мало роздаючих (0-4)
            } else if (seeds <= 14) {
                item.classList.add('medium-seeds-border');     // Середня кількість (5-14)
            } else {
                item.classList.add('high-seeds-border');       // Багато роздаючих (15+)
            }
